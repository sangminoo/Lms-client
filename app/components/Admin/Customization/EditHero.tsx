    ...
    <>
      <div className="w-full 1000px:flex items-center ">
        ...
        <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
          <div className="relative top-[100px] flex justify-end items-center">
            <img
              src={image}
            ...
            <label
              htmlFor="banner"
              className="absolute bottom-0 right-0 z-20 dark:bg-gray-500 bg-gray-300 rounded-full p-2"
            >
        ...
        <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
          <textarea
            className="dark:text-white resize-none text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[60px] 1500px:text-[70px] font-[600] 1100px:!w-[64%] bg-transparent"
            id=""
            value={title}
            ...
            className={`${styles.button} 
              !w-[100px] !min-h-[40px] dark:text-white text-black bg-[#cccccc34] ${
                ...
                data?.layout?.banner?.image?.url !== image
                  ...
                  : "!cursor-not-allowed"
              } !rounded absolute bottom-2 right-12`}
            onClick={
              data?.layout?.banner?.title !== title ||
              data?.layout?.banner?.subTitle !== subTitle ||
              data?.layout?.banner?.image?.url !== image
