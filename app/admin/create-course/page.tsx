...
const CreateCourse = dynamic(() => import('../../components/Admin/Course/CreateCourse'), { ssr: false });
const DashboardHeader = dynamic(() => import('@/app/components/Admin/DashboardHeader'), { ssr: false });
